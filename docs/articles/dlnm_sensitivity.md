...
You can see that this creates the same `cb` object as in the basic DLNM
(with some novel attributes removed):
...
Ok so now how to use this to its fullest potential. One application
