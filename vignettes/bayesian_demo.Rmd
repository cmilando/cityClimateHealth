---
title: "Using Spatial Bayesian methods in `cityClimateHealth`"
output:
  rmarkdown::html_vignette:
    fig.retina: 2
    dev: svg
vignette: >
  %\VignetteIndexEntry{Using Spatial Bayesian methods in `cityClimateHealth`}
...
All of the other objects associated with `condPois_1stage` or `condPois_2stage` will also work here, along with the `_list` and factor coding
