...
![Crossbasis Matrix Visualization.](/Users/carolinesarpy/Desktop/ClimateCityHealth/Crossbasis_Matrix.png)
*Crossbasis Matrix Visualization. Source: [Gasparrini et al., 2017](https://onlinelibrary.wiley.com/doi/full/10.1111/biom.12645)*
...
We are also testing this for non-fatal outcomes, which as the literature shows for temperature does not always have a U-shaped exposure-response curve which also means that the choice of centering point becomes critical for effect estimation. For example:   

![Example of Temperature Exposure-Response Curves without a U-shape.](/Users/carolinesarpy/Desktop/ClimateCityHealth/Temp_response_curve.png)
*Example of Temperature Exposure-Response Curves without a U-shape. Source: [Zeng et al., 2016](https://pmc.ncbi.nlm.nih.gov/articles/PMC4808942/)*
...
You can use outcomes with a variety of timings. This package supports daily, monthly, and yearly outcomes.
...
* **Time-series** -- time is controlled by a natural spline with a specific number of knots for year, day of year, season, and decade. Additional control is added by a categorical variable for day of week. See below for examples: 
  ...
  * [Chen et al., 2021](https://www.sciencedirect.com/science/article/pii/S2542519621001686): Time-series analysis of exposure to fine particulate matter and risk of hospitalization.  
  * [Gasparrini et al., 2022](https://www.thelancet.com/journals/lanplh/article/PIIS2542-5196(22)00138-3/fulltext): Time-series analysis of temperature-related mortality.  
  * [Sugeno et al., 2023](https://link.springer.com/article/10.1186/s12889-023-17277-0): Time-series analysis of temperature and precipitation exposure and risk of Dengue virus incidence.  
...
As such there as several places where numeric cut-offs are necessary: MinN, strata_total. These are sensitivity points.
