...
We applied a distributed lag non-linear modeling (DLNM) framework to capture both the non-linear and lagged effects of temperature exposure. [Gasparrini 2011](https://www.jstatsoft.org/article/view/v043i08) describes these methods, and the R package `dlnm`.
