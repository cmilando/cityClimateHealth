---
title: "Calculating attributable numbers and rates in `cityClimateHealth`"
output:
  rmarkdown::html_vignette:
    fig.retina: 2
    dev: svg
vignette: >
  %\VignetteIndexEntry{Calculating attributable numbers and rates in `cityClimateHealth`}
