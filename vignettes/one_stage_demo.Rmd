...
```{r}
# this model is an example of what NOT to do, and won't run!
m2 <- condPois_1stage(exposure_matrix = middlesex_exposure_mat, global_cen = 0, outcomes_tbl = middlesex_deaths_tbl, multi_zone = TRUE, verbose = 1)
plot(m2)
```
